...
CanCreateOneAndGet<SerieWithEpisodes>
{
  ...
  private async createFromFiles(id: SerieId): Promise<SerieWithEpisodes | null> {
  ...
  async getOneByIdOrCreateFromFiles(id: SerieId): Promise<SerieWithEpisodes | null> {
  ...
  async getOneById(id: SerieId): Promise<SerieWithEpisodes | null> {
