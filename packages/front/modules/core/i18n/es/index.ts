    ...
    musics: {
      ...
      lists: {
        ...
        playlists: {
          ...
          none: "Ninguna",
          alreadyAdded: "\"{musicTitle:string}\" ya estaba en \"{playlistName:string}\" y no se ha \
añadido.",
          added: "\"{musicTitle:string}\" añadida a \"{playlistName:string}\"",
        },
        smartPlaylists: {
      ...
      bulkEdit: {
        activate: "Selección múltiple",
        editCount: "Editar {count:number} {{count:música|músicas}}",
        selectedCount: "{count:number} {{count:seleccionada|seleccionadas}}",
        selectMusics: "Selecciona músicas",
        exit: "Salir",
        editSelected: "Editar seleccionadas",
        saving: "Guardando…",
        applyToCount: "Aplicar a {count:number} {{count:seleccionado|seleccionados}}",
        currentValuesTitle: "Valores actuales — {field:string}",
        selectItem: "Seleccionar música",
        tags: {
          add: "Añadir",
          replace: "Reemplazar",
          remove: "Quitar",
