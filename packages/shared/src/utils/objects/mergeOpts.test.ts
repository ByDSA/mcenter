...
describe("mergeOpts", () => {
  ...
  it(
    "should return inputParams when defaultParams is an empty object and inputParams is defined",
    () => {
      const defaultParams = {};
      const inputParams = {
        param1: "value1",
  ...
  it(
    "should return an empty object when defaultParams and inputParams are both empty objects",
    () => {
    // Arrange
      const defaultParams = {};
      const inputParams = {};
  ...
  it(
    "should prioritize inputParams values over defaultParams values when they have \
overlapping properties",
  ...
  it(
    "should include additional properties in the merged object when inputParams has \
additional properties",
  ...
  it(
    "should include null or undefined properties in the merged object when inputParams has \
null or undefined values",
  ...
  it(
    "should include empty arrays or objects in the merged object when inputParams has them",
    () => {
    // Arrange
      const defaultParams = {
        prop1: "value1",
