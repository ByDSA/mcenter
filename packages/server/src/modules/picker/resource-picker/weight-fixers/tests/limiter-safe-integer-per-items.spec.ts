...
import { LimiterWeightFixer as LimiterSafeIntegerPerItems } from "../limiter-safe-integer-per-items";
...
${testCase.initialWeight} and resources length = ${testCase.resources.length}`,
    async () => {
